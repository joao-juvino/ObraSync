...
@Entity @Table(name="tb_evidencia_vistoria") public class EvidenciaVistoria {
 ...
 @Column(nullable=false,length=255) private String nomeArquivo; @Column(nullable=false,length=100) private String tipoMime; @Column(nullable=false) private long tamanho;
 @Column(nullable=false,unique=true,length=255) private String caminhoOuIdentificador; @Column(length=500) private String descricao; @Column(nullable=false) private LocalDateTime dataUpload=LocalDateTime.now();
